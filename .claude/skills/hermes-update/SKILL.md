...
| `tools/tts_tool.py` | `patches/tts-tool-audio-title.patch` | name the audio file from the audio-gateway's `X-Audio-Title` header (title generated by the gateway) instead of `tts_<timestamp>` |
